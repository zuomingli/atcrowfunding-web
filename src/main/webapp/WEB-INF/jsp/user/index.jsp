          ...
          /*   function changePageno(pageno){
            ...
            function pageQuery(pageno){
            	...
            	$.ajax({
            		...
            		data:jsonData,
            		beforeSend:function(loadingIndex){
            		...
            		success:function(result){
						...
						tableContent+='<td><input type="checkbox" id="allSelBox"></td>';
						...
						tableContent+='	</button>';
						tableContent+='	<button onclick="goUpdatePage('+user.id+')" type="button" class="btn btn-primary btn-xs">';
						tableContent+='		<i class=" glyphicon glyphicon-pencil"></i>';
						tableContent+='	</button>';
						tableContent+='	<button type="button" onclick="deleteUser('+user.id+',\''+user.loginacct+'\')" class="btn btn-danger btn-xs">';
						...
						tableContent+='</tr>';
            			 ...
            			 if(pageno<userPage.totalno){
            				...
            				layer.msg("用户信息分页查询失败",{time:2000,icon:5,shift:6},false)
            			}
            		}
            	});
            }
    			    ...
    			    $.ajax({
    			    	...
    			    	success:function(result){
    			    		if(result.success){
    			    			...
    			    			layer.msg("用户信息删除失败",{time:2000,icon:5,shift:6},false)
    			    		}
    			    	}
    			    })
    			}, function(cindex){

			...
			<div class="panel panel-default">
			  ...
			  <div class="panel-body">
				<form id="userForm" role="form">
				  ...
				  <button type="button" id="updateBtn" class="btn btn-success"><i class="glyphicon glyphicon-pencils"></i> 修改</button>
        ...
        <script type="text/javascript">
            $(function () {
			    ...
			    $("#updateBtn").click(function(){
			    	 ...
			    	 if(loginacct==""){
			    			layer.msg("登录账号不能为空，请输入",{time:2000,icon:5,shift:6},false);
			    			return;
			    	 ...
			    	 $.ajax({
			    		 ...
			    		 success:function(result){
			    				...
			    				if(result.success){
			    					...
			    					layer.msg("用户信息修改失败，请重新操作",{time:2000,icon:5,shift:6},false)
			    				}
			    		 }
			    	 })
			     });
